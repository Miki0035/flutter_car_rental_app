...
import 'package:car_rental_app/presentation/screens/maps_details.dart';
import 'package:car_rental_app/presentation/widgets/car_card.dart';
import 'package:car_rental_app/presentation/widgets/more_car.dart';
import 'package:car_rental_app/utils/constants/image_strings.dart';
import 'package:flutter/material.dart';

class CardDetailsScreen extends StatefulWidget {
  const CardDetailsScreen({super.key, required this.car});
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (_) =>
                                  MapsDetailsScreen(car: widget.car)));
                    },
                    child: Container(
                      height: 170,
                      decoration: BoxDecoration(
